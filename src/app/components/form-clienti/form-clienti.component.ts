...
export class FormClientiComponent implements OnInit {
    ...
    onSubmit(datiForm: {
        ...
        this.clientiService .saveCliente(this.id, datiForm.value).subscribe((res) => {
    ...
    ngOnInit(): void {
        this.route.params.subscribe(params => {
            ...
            this.formInit();
            this.caricaDati();
            // this.caricaTipoCliente()
            // this.caricaComune()
            // this.caricaProvincia()
        });
    }
    ...
    caricaDati() {
        ...
        this.provinciaService.recuperaProvincia(0).subscribe(res =>
            this.provincia = res.content

        )
        this.comuneService.recuperaComune().subscribe(res =>
    ...
    // caricaProvincia(){
    //     this.provinciaService.recuperaProvincia().subscribe(res => {
    //         this.provincia = res.content
